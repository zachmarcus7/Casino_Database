...
* to the Games page, along with additional 
...
module.exports = function(){
    ...
    */
     ...
     * Output:  n/a
    */
    function getDealers(res, mysql, context, complete){
     ...
     * Output:  n/a
    */
    function getTableID(res, mysql, context, complete){
     ...
     * Output:  n/a
    */
    function addRow(mysql, amount_earned, date, game_type, players_total, table_ID, dealer_ID){
    ...
    */
    router.get('/', function(req, res){
        ...
        if (req.query.callType == "add") {
            addRow(mysql, req.query.amount_earned, req.query.date, req.query.game_type, req.query.players_total, req.query.table_ID, req.query.dealer_ID);
            res.end();
        } else {
